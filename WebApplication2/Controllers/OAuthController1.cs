...
namespace WebApplication2
{
    public class OAuthController1 : Controller
    {
        public void Callback(string code, string error, string state)
        {
            ...
            {
                var tokenFile = "C:\\Users\\Vasilis\\source\\repos\\Google Apiv1\\Google Apiv1\\Files\\tokens.json";
                ...
                request.AddQueryParameter("redirect_uri", "https://localhost:7185/oauth/callback"); // tha mpei edw to redirect url
        ...
        {
            var tokenFile = "C:\\Users\\Vasilis\\source\\repos\\WebApplication2\\WebApplication2\\Files\\tokens.json";
            var credentialsFile = "C:\\Users\\Vasilis\\source\\repos\\WebApplication2\\WebApplication2\\Files\\Credentials.json";
            var credentials = JObject.Parse(System.IO.File.ReadAllText(credentialsFile));
